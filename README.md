...
- Python 3.11
- Node v20.19.0+
- [Conda](https://docs.conda.io/projects/conda/en/latest/user-guide/getting-started.html#starting-conda)
...
# Additional system dependencies (for conda users)

```bash
conda install -c conda-forge c-compiler cxx-compiler cmake --force-reinstall
```
